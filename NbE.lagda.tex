...
\end{code}
This constructs the most fundemental pieces of a contextual structure. We now
...
When we add the first condition in, the definition of $\Lambda$ is now required
